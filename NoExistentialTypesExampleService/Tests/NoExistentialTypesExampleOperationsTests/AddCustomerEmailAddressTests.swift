...
class AddCustomerEmailAddressTests: EventLoopAwareTestCase {
    ...
    func testAddCustomerEmailAddress() async throws {
        ...
        let dynamodbTable = operationsContext.dynamodbTable

        let internalCustomerId = (OperationsAttributes.customerKeyPrefix + [TestVariables.staticId]).dynamodbKey
    ...
    func testAddCustomerEmailAddressUpToLimit() async throws {
        ...
        let externalCustomerId = (OperationsAttributes.externalCustomerPrefix + [TestVariables.staticId]).dynamodbKey
        let operationsContext = NoExistentialTypesExampleOperationsContext(
    ...
    func testAddCustomerEmailAddressOverLimit() async throws {
        ...
        } catch NoExistentialTypesExampleError.customerEmailAddressLimitExceeded(_) {
    ...
    func testAddCustomerEmailAddressUnacceptableConcurrency() async throws {
        ...
        do {
            ...
            XCTFail("Expected error not thrown.")
        } catch NoExistentialTypesExampleError.concurrency(_) {
    ...
    func testAddCustomerEmailAddressUnknownCustomer() async throws {
        ...
        do {
            ...
            XCTFail("Expected error not thrown.")
        } catch NoExistentialTypesExampleError.unknownResource {
    ...
    func testAddCustomerEmailAddressAlreadyRegistered() async throws {
        ...
        do {
            ...
            XCTFail("Expected error not thrown.")
        } catch NoExistentialTypesExampleError.customerEmailAddressAlreadyExists {
